...
if __name__=="__main__":
    ...
    rospy.init_node('windrunner_teleop')
    ...
    pub_rear_left = rospy.Publisher('/windrunner/rear_left_wheel_controller/command', Float64, queue_size=10) # Add your topic for move here '' Eg '/my_robot/longitudinal_controller/command'
    pub_rear_right = rospy.Publisher('/windrunner/rear_right_wheel_controller/command', Float64, queue_size=10)
    ...
    try:
        ...
        while(1):
            ...
            pub_rear_left.publish(control_speed) # publish the control speed. 
            pub_rear_right.publish(control_speed)
